...
public class CameraShaker : MonoBehaviour
{
    ...
    */
    ...
    IEnumerator Shake()
    {
        ...
        _gameManager.canvas.GetComponent<Canvas>().renderMode = RenderMode.WorldSpace;
        ...
        isRunning = false;
        if (!isRunning)
            _gameManager.canvas.GetComponent<Canvas>().renderMode = RenderMode.ScreenSpaceCamera;
    }
